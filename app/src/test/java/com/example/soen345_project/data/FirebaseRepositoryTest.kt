...
class FirebaseRepositoryTest {
    ...
    private lateinit var mockResvRepoRef: DatabaseReference
    ...
    fun setUp() {
        ...
        mockResvRepoRef = mock(DatabaseReference::class.java)
    ...
    fun transaction_success_and_aborts() {
        ...
        `when`(mockMutableData.getValue(Integer::class.java)).thenReturn(2 as java.lang.Integer)
        captor.value.doTransaction(mockMutableData)

        `when`(mockMutableData.getValue(Integer::class.java)).thenReturn(10 as java.lang.Integer)
        captor.value.doTransaction(mockMutableData)
